...
use RedCat\Framework\Templix\LoremIpsum as LoremIpsumGen;
class Loremipsum extends \RedCat\Templix\Markup {
	...
	function load(){
		...
		if($this->dynamic){
			...
			$this->innerHead[] = "<?php echo \RedCat\Framework\Templix\LoremIpsum::get($count,$wordsPerParagraph,$format,$loremipsum,$html,$mini);?>";
		}
		else{
